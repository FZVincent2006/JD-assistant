...
1. 打开扩展侧栏，选择“飞书文档”。当前标签页不必停留在飞书。
2. 点击“授权飞书”或“重新授权”。
3. 点击“检查测试副本”，确认能读取文档版本和两区公司数量。
4. 粘贴一家公司的一个或多个岗位 JD，点击“解析公司与岗位”。
5. 编辑预览字段并处理所有必填错误。
6. 点击“生成写入计划”，确认是“新公司置顶”或“老公司追加岗位”，并检查岗位序号。
7. 点击“确认并写入测试副本”，在系统确认框中再次确认。
8. 只有侧栏显示两阶段均通过回读校验后，才视为完成；可点击“打开文档检查”做人工复核。
...
- “部分完成”表示岗位 JD 已通过回读校验，但 Portfolio 未完成。按提示打开测试副本，只修复 Portfolio 指定位置。
...
- manifest 不含剪贴板、debugger 或飞书页面注入权限。
